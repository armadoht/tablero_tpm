...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="hero">
					<h1><span>Protocolo de alimentación saludable y su impacto en el sistema inmunológico </span></h1>
					<div class="bor"></div>
					<p></p>
				</div>
			</div>
		...
		<div class="row">
            <div class="col-md-12">
                <video height="500" autoplay controls>
                    ...
                    <source src="view/videos/10.mp4" type="video/mp4">
                </video>
            </div>
		</div>
	</div>
    ...
    <script type="text/javascript">
		$(document).ready(function(){
  			setTimeout(function(){
			location.href = "index.php?controller=Covid&action=video_once";
			}, 60000);
		});
	</script>
