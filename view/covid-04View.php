...
<!--#-->
	...
	<title>Procolo al salir de casa_alta</title>
</head>
<body>
	<!-- My Header Start-->
	<header>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="hero">
					<h1><span>Procolo al salir de casa</span></h1>
					<div class="bor"></div>
					<p></p>
				</div>
			</div>
		...
		<div class="row">
            <div class="col-md-12">
                <video height="500" autoplay controls>
                    ...
                    <source src="view/videos/04.mp4" type="video/mp4">
                </video>
            </div>
		</div>
	</div>
    ...
    <script type="text/javascript">
		$(document).ready(function(){
  			setTimeout(function(){
			location.href = "index.php?controller=Covid&action=video_cinco";
			}, 60000);
		});
	</script>
